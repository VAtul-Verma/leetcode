...
class Tree
{
    ...
    public static int isSumProperty(Node root)
    {
      ...
      public static boolean childrensum(Node root){
        if(root==null)return true;  //if only single node then it return the true;
        if(root.left==null && root.right==null)return true;  //if its a leave node the answer is true
        int sum=0;
